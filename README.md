...
* General Requirements
    - [x] The project idea must be chosen based on the students’ interests and inclinations, with the condition that the same idea is not repeated by more than one group.
    - [x] The application must have at least 7 pages.
    - [x] Each team should not have more than 3 students
* Design Requirements
